...
def display_header():
    ...
    try:
        with open("AI.jpg", "rb") as img_file:
            ...
            logo_html = f'<img src="data:image/jpeg;base64,{logo_base64}" alt="AI Logo" class="logo-image" style="max-height: 100px;">'
    except:
...
def display_analysis_results(analysis_result):
    ...
    st.markdown(
        '<div style="text-align: right; font-size: 0.8rem; color: #888; margin-bottom: 10px;">Powered by AI Recruitment</div>',
        unsafe_allow_html=True
    )
    ...
    with col2:
        report_content = f"""
# AI Recruitment - Resume Analysis Report
...
"""
        ...
        href = f'<a class="download-btn" href="data:text/plain;base64,{report_b64}" download="AI_resume_analysis.txt">📊 Download Analysis Report</a>'
    ...
    if st.button("Generate Interview Questions"):
        if generate_questions_func:
            with st.spinner("Generating personalized interview questions..."):
                ...
                download_content = f"# AI Recruitment - Interview Questions\n\n"
                ...
                # Add AI branding to download content
                ...
                if questions:
                    ...
                    href = f'<a class="download-btn" href="data:text/markdown;base64,{b64}" download="AI_interview_questions.md">📝 Download All Questions</a>'
                    st.markdown(href, unsafe_allow_html=True)
    ...
    if st.button("Generate Resume Improvements"):
        if improve_resume_func:
            with st.spinner("Analyzing and generating improvements..."):
                ...
                # Create content for download
                download_content = f"# AI Recruitment - Resume Improvement Suggestions\n\nTarget Role: {target_role if target_role else 'Not specified'}\n\n"
                ...
                href = f'<a class="download-btn" href="data:text/markdown;base64,{b64}" download="AI_resume_improvements.md">📝 Download All Suggestions</a>'
                st.markdown(href, unsafe_allow_html=True)
        ...
        if get_improved_resume_func:
            with st.spinner("Creating improved resume..."):
                ...
                with col1:
                    ...
                    href = f'<a class="download-btn" href="data:file/txt;base64,{b64}" download="AI_improved_resume.txt">📄 Download as TXT</a>'
                    st.markdown(href, unsafe_allow_html=True)
...
"""
                    ...
                    md_href = f'<a class="download-btn" href="data:text/markdown;base64,{md_b64}" download="AI_improved_resume.md">📝 Download as Markdown</a>'
